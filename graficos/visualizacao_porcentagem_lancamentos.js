var specMarketShare = {
  ...
  "title": "Porcentagem de Lançamentos (Market Share)",
  ...
  "encoding": {
    ...
    "y": { "aggregate": "count", "type": "quantitative", "stack": "normalize", "axis": {"title": "Porcentagem do Total", "format": "%"} },
...
vegaEmbed('#vis_market_share', specMarketShare, {"actions": false});
